...
public static double withholdingTax(double taxableIncome) {
    ...
    public static void allEmployee() {
        ...
        for (String[] empData : employees) {
            ...
            System.out.printf("%-18s %-15s %-15s %-15s %-15s %-15s %-15s %-18s %-12s%n",
                    "Cutoff Date",
                    "Hours", "Gross", "SSS", "PhilHealth", "Pag-IBIG",
                    "Tax", "Total Deductions", "Net");
            ...
            for (int month = 6; month <= 12; month++) {
                ...
                System.out.printf("%-18s %-15.2f %-15.2f %-15s %-15s %-15s %-15s %-18s %-12.2f\n",
                        monthName + " 1-15",
                        firstHalf,
                        grossFirst,
                        "__",
                ...
                System.out.printf("%-18s %-15.2f %-15.2f %-15.2f %-15.2f %-15.2f %-15.2f %-18.2f %-12.2f\n",
                        monthName + " 16-" + daysInMonth,
                        secondHalf,
                        grossSecond,
                        sss,
                        philhealth,
